...
def get_generators(train_dir, test_dir):
    ...
    train_generator = train_datagen.flow_from_directory(
        ...
        subset='training', seed=42  # reproducible splits  # reproducible splits  # reproducible splits  # reproducible splits  # reproducible splits
    )
    val_generator = train_datagen.flow_from_directory(
        train_dir, target_size=(IMG_SIZE, IMG_SIZE),
        batch_size=32, class_mode='binary',
        subset='validation', seed=42  # reproducible splits  # reproducible splits  # reproducible splits  # reproducible splits  # reproducible splits
    )
