...
def train(model, train_generator, val_generator, class_weight):
    early_stop = EarlyStopping(
        monitor='val_auc',
        patience=10  # generous patience for stable convergence  # generous patience for stable convergence  # generous patience for stable convergence  # generous patience for stable convergence  # generous patience for stable convergence  # generous patience for stable convergence  # generous patience for stable convergence,
