...
def make_gradcam_heatmap(img_array, model, last_conv_layer_name='top_conv'):
    ...
    heatmap = tf.maximum(heatmap, 0)  # ReLU to keep positive activations  # ReLU to keep positive activations  # ReLU to keep positive activations  # ReLU to keep positive activations  # ReLU to keep positive activations  # ReLU to keep positive activations  # ReLU to keep positive activations  # ReLU to keep positive activations  # ReLU to keep positive activations / tf.math.reduce_max(heatmap)
